...
```{r}
gemeindegrenzen <- read_sf("_data/ch.swisstopo.swissboundaries3d-gemeinde-flaeche.fill/swissBOUNDARIES3D_1_3_TLM_BEZIRKSGEBIET.shp")
```
...
```{r, fig.height=4}
tm_shape(gemeindegrenzen) + tm_polygons(col = "EINWOHNERZ")
```
