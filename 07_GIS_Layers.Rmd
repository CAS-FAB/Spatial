...
- importiere nun `dhm25` und wiederhole das Zuschneiden mittels `crop` sowie das visualieren mittels `tmap`
...
Erstelle ein neues Objekt `landquart`, welches nur die Gemeinde Landquart beinhaltet und visualiere diese.
...
- Visualiere das Resultat mit `tmap`
